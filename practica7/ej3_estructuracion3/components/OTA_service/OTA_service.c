/* Advanced HTTPS OTA example
   ...
   https://192.168.43.122:8070/helloWorld_toUpdate.bin
*/
#include <string.h>
#include <inttypes.h>
...
void advanced_ota_example_task(void *pvParameter)
{
    ...
    if (err != ESP_OK) {
        ESP_LOGE(TAG, "(%s) esp_https_ota_read_img_desc failed", esp_err_to_name(err));
        ESP_LOGE(TAG, "Content: (%s)", (char *)https_ota_handle);
        goto ota_end;
    }
